...
export const EthProvider = process.env.ETH_PROVIDER || 'local'; // 'infura', 'etherscan', or will default to localhost RPC (testrpc, Geth, or Parity..)
export const EthNetwork = process.env.ETH_NETWORK || 'kovan'; // Options are 'mainnet', 'ropsten', 'rinkeby', 'kovan'
export const EthApiToken = process.env.ETH_API_TOKEN; // Required for Infura or Etherscan
