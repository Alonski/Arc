...
import { EthProvider, EthNetwork, EthApToken } from './utils.js';
...
export function getWeb3() {
  ...
  if (typeof window !== "undefined" && typeof window.web3 !== "undefined") {
    ...
    switch (ethProvider) {
      case 'infura':
        providerURL = "https://" + EthNetwork + ".infura.io/UeW8cwaou03qFgsAHoDP"; // TODO: store the API key somewhere
        break;
      default:
        providerURL = "http://localhost:8545";
    }

    preWeb3 = new Web3(new Web3.providers.HttpProvider(providerURL));
  }
